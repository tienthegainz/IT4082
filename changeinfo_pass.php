...
<head>
  ...
  <title>HST &mdash; Private Info</title>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="owl-carousel owl-carousel-fullwidth">
              <div class="item">
                <div class="testimony-slide active text-center">
                  <span>Ha Viet Tien, via <a href="#" class="facebook">Facebook</a></span>
                  <blockquote>
                    <p>&ldquo;Chung toi khong phai Facebook. ( ͡° ͜ʖ ͡°)&rdquo;</p>
                  </blockquote>
                </div>
              </div>
              <div class="item">
                <div class="testimony-slide active text-center">
                  ...
                  <span>Tran Vu Duc, via <a href="#" class="facebook">Facebook</a></span>
                  <blockquote>
                    <p>&ldquo;Chung toi cung khong phai Coc Coc. ( ͡° ͜ʖ ͡°)&rdquo;</p>
                  </blockquote>
                </div>
              </div>
              <div class="item">
                <div class="testimony-slide active text-center">
                  ...
                  <span>Nhom 3, via <a href="#" class="facebook">Facebook</a></span>
                  <blockquote>
                    <p>&ldquo;Nen noi chung la ban cu yen cmn tam. ( ͡° ͜ʖ ͡°)&rdquo;</p>
                  </blockquote>
                </div>
              </div>
            </div>
          ...
          <!-- <div class=" col-md-4 col-sm-4 col-xs-6">  <div class="col-md-12 text-center ">-->
          <?php
              echo '<div class="form ">
              <form action="database/change_func.php" method="post">
                <input type="password" name="old_pass" placeholder="Old Pass">
                <br>
                <input type="password" name="new_pass" placeholder="Enter new Pass">
                <br>
                <input type="password" name="new_pass2" placeholder="Re-enter new pass">
                <br>
